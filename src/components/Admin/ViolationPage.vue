  ...
  <el-container style="height: 100vh;">
    ...
    <el-container>
      ...
      <el-main>
        ...
        <el-card style="margin: 0 auto; width: 98%; padding: 0;">
          <div style="display: flex; justify-content: center; align-items: center;">
            <el-table :data="tableData.slice((currentPage - 1) * pageSize, currentPage * pageSize)" style="width: 100%;" :row-style="{'text-align': 'center'}">
              ...
              <el-table-column prop="idCard" label="身份证号" width="215" align="center"></el-table-column>
              <el-table-column prop="stuName" label="姓名" width="160" align="center"></el-table-column>
              ...
              <el-table-column prop="punishReason" label="违规说明" width="200" align="center"></el-table-column>
